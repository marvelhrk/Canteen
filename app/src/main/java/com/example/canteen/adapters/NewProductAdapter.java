...
import com.example.canteen.activities.ProductViewActivity;
import com.example.canteen.interfaces.AddorRemoveCallbacks;
...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        Picasso.get().load(product.getImage()).error(R.drawable.search).into(holder.imageView, new Callback() {
            @Override
